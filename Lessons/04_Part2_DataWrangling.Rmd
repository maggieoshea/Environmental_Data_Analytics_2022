...
```{r, message = FALSE}
getwd()
setwd( "/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Lessons")
library(plyr)
library(tidyverse)
library(lubridate)
NTL.phys.data.PeterPaul <- read.csv("/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Processed/NTL-LTER_Lake_ChemistryPhysics_PeterPaul_Processed.csv")
                                    
                            
NTL.nutrient.data <- read.csv("/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/NTL-LTER_Lake_Nutrients_Raw.csv",stringsAsFactors = TRUE)
```
...
write.csv(NTL.nutrient.data.PeterPaul, row.names = FALSE, 
          file = "/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaul_Processed.csv")
...
write.csv(NTL.nutrient.data.PeterPaul.gathered, row.names = FALSE, 
          file = "/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv")
...
> note: Good for if there are lots of NAs ?
...
Litter.June2016 <- read.csv("/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/NIWO_Litter/NEON_NIWO_Litter_massdata_2016-06_raw.csv")
Litter.July2016 <- read.csv("/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/NIWO_Litter/NEON_NIWO_Litter_massdata_2016-07_raw.csv")
Litter.August2016 <- read.csv("/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/NIWO_Litter/NEON_NIWO_Litter_massdata_2016-08_raw.csv")
...
```{r}
LitterFiles = list.files(path = "/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/NIWO_Litter/", pattern="*.csv", full.names=TRUE)
LitterFiles
...
```{r}
Trap <- read.csv("/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/NEON_NIWO_Litter_trapdata_raw.csv")
...
write.csv(LitterTrap, row.names = FALSE, 
          file ="/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Processed/NEON_NIWO_Litter_mass_trap_Processed.csv")
```
...
write.csv(NTL.PeterPaul.summaries, row.names = FALSE, 
          file ="/Users/maggieoshea/Desktop/Spring 2022/Data Analytics/Environmental_Data_Analytics_2022/Data/Processed/NTL-LTER_Lake_Summaries_PeterPaul_Processed.csv")
