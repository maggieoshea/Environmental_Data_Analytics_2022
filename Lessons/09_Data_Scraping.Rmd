...
* Do you see where it states the registrant? ("American & Efird, Inc.") Yes
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant, # bang bang says this refers to a variable not a value
...
#By putting as variables you can get a bunch of years by just changing the year 
...
scrape.it <- function(the_year, the_facility){
  ...
  #Makes it one second (can change to 5 seconds with changing 1 to a 5) slower --> to make websites not think they are under attack 
