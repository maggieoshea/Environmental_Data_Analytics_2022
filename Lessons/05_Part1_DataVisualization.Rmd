...
* geom_text
> Note: Each one is an added layerr 
...
* size
* transparency
#Note: if you are plotting many variables together than should do aesthetics for all layers/variables on the plot
...
ggplot(EPAair, aes(x = Date, y = Ozone)) + 
  geom_point()
#Data frame always the first thing in your ggplot --> has to be a dataframe for ggplot! 
...
# Filter dataset within plot building and facet by multiple variables --> usually better to filter before but can use subset if needed
PMplot.faceted2 <- 
